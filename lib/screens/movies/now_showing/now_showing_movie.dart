...
class NowShowingMovie extends StatelessWidget {
  const NowShowingMovie({Key? key}) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ChangeNotifierProvider(
          ...
          child: Builder(
            builder: (context) {
              final modelData = Provider.of<MovieProvider>(context);

              if (modelData.movieState == MovieState.loading) {
                return const Center(child: CircularProgressIndicator());
              }
              if (modelData.movieState == MovieState.error) {
                return Column(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: GridView.builder(
                          ...
                          itemCount: modelData.movies.length,
                          itemBuilder: (context, index) {
                            final movieData = modelData.movies[index];
